...
def parse_commandline():
    ...
    usage=f'''
    python golang_get_stats_github.py -o /path/to/file
    ...
    parser.add_argument('-o', '--out', help='output file (default is raw JSON output)', type=str, default='./golang_github_stats.json')
    ...
    if outputfile[-1] == "/":
        outputfile = outputfile+"golang_github_stats.json"
