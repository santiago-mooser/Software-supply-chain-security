...
def get_most_downloaded_packages():
    url= "https://api.github.com/search/repositories?q=language:c&sort=stars&order=desc&per_page=250"
...
def parse_commandline():
    ...
    usage=f'''
    python c_get_stats_github.py -o /path/to/file
    ...
    parser.add_argument('-o', '--out', help='output file (default is raw JSON output)', type=str, default='./c_stats.json')
    ...
    if outputfile[-1] == "/":
        outputfile = outputfile+"c_stats.json"
