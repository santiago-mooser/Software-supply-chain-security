...
def parse_commandline():
    ...
    usage=f'''
    python nuget_get_stats.py -o /path/to/file
    ...
    parser.add_argument('-o', '--out', help='output file (default is raw JSON output)', type=str, default='./nuget_stats.json')
    ...
    if outputfile[-1] == "/":
        outputfile = outputfile+"nuget_stats.json"
