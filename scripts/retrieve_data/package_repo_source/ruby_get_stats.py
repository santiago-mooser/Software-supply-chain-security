...
def parse_commandline():
    ...
    usage='''
    python ruby_get_stats.py -o /path/to/file
    ...
    parser.add_argument('-o', '--out', help='output file (default is raw JSON output)', type=str, default='./ruby_stats.json')
    ...
    if outputfile[-1] == "/":
        outputfile = outputfile+"ruby_stats.json"
